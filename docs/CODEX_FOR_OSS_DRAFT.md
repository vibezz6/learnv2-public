...
Use these as short draft answers after the repository is public and CI is green.
...
Credits would support OSS maintenance: issue triage, security review, PR review, test generation, curriculum quality checks, and optional privacy-conscious AI study review experiments. The core app stays local-first and usable without AI.

## Public Repo Checklist Before Submitting
